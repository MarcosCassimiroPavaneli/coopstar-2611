          ...
          {services.map((service, i) => {
            ...
            return (
              <Reveal key={service.id} delay={i * 0.12}>
                <article className="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-card">
                  <div className="relative h-52 overflow-hidden">
                    ...
                    <div className="absolute top-3 right-3 rounded-lg bg-white/90 px-2 py-1 shadow-sm backdrop-blur-sm">
                      <img src="/images/logo.png" alt="Coopstar Express" className="h-4 w-auto object-contain" />
                    </div>
                    <div className="absolute bottom-4 left-4 rounded-full bg-white/90 p-2.5 text-brand-blue shadow-card backdrop-blur-sm">
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <a
                      href="#contato"
                      className="mt-6 inline-flex items-center font-semibold text-brand-blue transition-colors hover:text-brand-navy"
                    >
                      Solicitar orçamento
